      ...
      button.addEventListener(
        ...
        event => {
          ...
          if (Number(product.price || 0) <= 0) {
            openProduct(id);
            toast(
              "Ce produit doit être configuré avant la commande.",
              "error"
            );
            return;
          }
        ...
        ${
          price <= 0
            ? `
              ...
              ">
                Le prix de ce produit doit être défini
